...
do_install(){
  install -d ${D}${systemd_system_unitdir}
	...
	install -m 755 ${DEPLOY_DIR_IMAGE}/myir-image-core-ota-openstlinux-weston-${MACHINENAME}.ext4  ${D}/home/root/ld25x_images/myir-image-full.ext4
	...
	install -m 755 ${DEPLOY_DIR_IMAGE}/kernel/Image ${D}/home/root/ld25x_images/Image
	install -m 755 ${DEPLOY_DIR_IMAGE}/kernel/myb-stm32mp257x-2GB.dtb ${D}/home/root/ld25x_images/myb-stm32mp257x-2GB.dtb
	install -m 755 ${DEPLOY_DIR_IMAGE}/kernel/myb-stm32mp257x-1GB.dtb ${D}/home/root/ld25x_images/myb-stm32mp257x-1GB.dtb
	install -m 755 ${DEPLOY_DIR_IMAGE}/kernel/myb-stm32mp257x-2GB-ethswitch.dtb ${D}/home/root/ld25x_images/myb-stm32mp257x-2GB-ethswitch.dtb
	install -m 755 ${DEPLOY_DIR_IMAGE}/kernel/myb-stm32mp257x-1GB-ethswitch.dtb ${D}/home/root/ld25x_images/myb-stm32mp257x-1GB-ethswitch.dtb
